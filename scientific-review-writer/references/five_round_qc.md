...
Run these checks before delivering a substantial scientific review manuscript or public demo.
...
## Round 3: Language And Style

- English by default unless otherwise requested.
- Formal manuscript has no prompt traces, workflow notes, claim-boundary labels, reviewer-response phrasing, or internal QC notes.
- Evidence wording matches evidence strength.
- Style is calibrated to discipline, journal, and user examples where provided.

## Round 4: Figures, Tables, And Export

- Every figure and table is cited.
- Captions are below figures.
- Figures match the written section and data.
- Labels are readable.
- Relative paths resolve.
- DOCX/PDF, when produced, embeds figures and preserves aspect ratios.

## Round 5: Citation, Privacy, And Release

- Citation/reference parity passed.
